 ...
 */
public class ContactMainTest extends ActivityUnitTestCase<MainActivity> {

    private Intent mStartIntent;
    private Button mButton;

    public ContactMainTest() {
    ...
    public void testPreconditions() {
        ...
        mButton = (Button) getActivity().findViewById(R.id.mainPicture);
    ...
    public void testSubLaunch() {
        ...
        getInstrumentation().waitForIdleSync();
        mButton = (Button) activity.findViewById(R.id.mainPicture);
        
        // This test confirms that when you click the button, the activity attempts to open
        // another activity (by calling startActivity) and not close itself (by calling finish()).
